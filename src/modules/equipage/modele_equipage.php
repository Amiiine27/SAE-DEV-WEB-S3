...
class ModeleEquipage extends Connexion
{
    ...
    public function ajout()
    {
        ...
        if (isset($_POST['submit']) && isset($_POST['description']) && isset($_POST['devise']) && isset($_POST['nom']) && isset($_FILES['embleme_clan'])) {
            ...
            $embleme_clan = $_FILES['embleme_clan']['name'];
            var_dump($embleme_clan);

//            // Traitement du logo
            $dossierLogos = "../images/clan/"; // Chemin du dossier de logos
            ...
            if ($sql->execute()) {
                ...
                $nouveaulogo = $nomFichierUnique;
                move_uploaded_file($_FILES['embleme_clan']['tmp_name'], $dossierLogos . $_FILES['embleme_clan']['name']);
                rename($dossierLogos . $_FILES['embleme_clan']['name'], $dossierLogos . $nomFichierUnique); // Rennomer le fichier
